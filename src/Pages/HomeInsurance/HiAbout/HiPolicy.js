...
const HiPolicy = () => {
  return (
    <div className='my-5'>
    <h2 className='text-2xl font-semibold text-center'>Protect One Of Your Most Valuable Assets- Your Home- By A Proper Home Insurance</h2>
    ...
    <h4 className='text-xl text-center font-semibold'>Finding house insurance that fits your needs and budget, We are near you!</h4>
