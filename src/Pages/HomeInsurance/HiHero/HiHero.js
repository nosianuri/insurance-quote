...
const HiHero = () => {
    return (
        <div style={{
            background: `url(https://i.ibb.co/NYjpVVC/Home-Insurance-1.jpg)`
            ...
            <div className='lg:px-32 px-5 bg-white bg-opacity-25 lg:pt-0 pt-16'>
                <div className='grid lg:grid-cols-2 grid-cols-1 gap-5 items-center justify-center pt-20'>
                    ...
                    <img className='mx-auto mb-5 w-28 ' src="https://i.ibb.co/KxxQrz5/home-anim.png" alt="" />
                        <h1 className='head-title lg:text-5xl text-[#3e37b7] text-4xl text-center font-semibold'>HOME INSURANCE </h1>
