  ...
  return (
    ...
    <div className=' order-2 px-3'>
        <div className='lg:py-5 py-5 lg:mx-16 '>
            <img className='mx-auto mb-5 w-16 ' src="https://i.ibb.co/8sCKJQB/auto-anim.png" alt="" />
            <h1 className='head-title lg:text-4xl md:text-3xl text-white text-3xl text-center font-semibold'>AUTO INSURANCE </h1>
