  ...
  return (
    ...
    <div className='lg:mx-28 mx-5'>
        ...
        <div className='grid lg:grid-cols-2 grid-cols-1 lg:my-10 my-5'>
          ...
          <div className='p-5'>
            <h1 className='font-semibold text-xl lg:mb-2'>Comprehensive insurance</h1>
          ...
          <div className='p-5'>
            <h1 className='font-semibold text-xl lg:mb-2'>Rental insurance</h1>
          ...
          <div className='p-5'>
            <h1 className='font-semibold text-xl lg:mb-2'>Ride share insurance</h1>
          ...
          <div className='p-5'>
          <h1 className='font-semibold text-xl lg:mb-2'>Emergency roadside service</h1>
          ...
          <div className='p-5'>
            <h1 className='font-semibold text-xl lg:mb-2'>More insurance options</h1>
