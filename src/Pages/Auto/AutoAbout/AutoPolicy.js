...
const AutoPolicy = () => {
    return (
        <div className='my-5'>
            <h2 className='text-2xl font-semibold text-center'>Take Advantage Of The Benefits Of Private Auto Policies With Insurance Trendy Quote</h2>
            ...
            <h4 className='text-xl text-center font-semibold'>Choose Insurance Trendy Quote Brokers for Your Private Auto Insurance</h4>
            <p className='my-3 text-sm'>AMC’s insurance brokers are committed to helping you find the best, most comprehensive private auto coverage. We compare rates from several companies to find the best rates for your unique situation. With AMC, you get policies that are:</p>
            <div className='grid lg:grid-cols-3 grid-cols-1 gap-5'>
                ...
                <div className='text-center'>
                    ...
                    <p className='text-sm mt-2'>At AMC, we understand how much your assets mean to you. Our policies protect you financially and give you the peace of mind you deserve.</p>
                </div>
            </div>
        </div>
    )
