...
const AutoPolicy = () => {
  return (
    <div className='my-5'>
    <h2 className='text-2xl font-semibold text-center'>Take Advantage Of The Benefits Of Private Auto Policies With AMC Insurance</h2>
    ...
    <h4 className='text-xl text-center font-semibold'>Choose AMC Insurance Brokers for Your Private Auto Insurance</h4>
