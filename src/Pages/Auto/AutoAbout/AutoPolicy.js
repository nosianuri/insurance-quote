        ...
        <div className='my-5'>
            ...
            <div className='grid lg:grid-cols-3 grid-cols-1 gap-5'>
                <div className='text-center'>
                    <h3 className='text-[#201e44] font-semibold'>Affordable</h3>
                ...
                <div className='text-center'>
                    ...
                    <h3 className='text-[#201e44] font-semibold'>High Quality</h3>
                ...
                <div className='text-center'>
                    <h3 className='text-[#201e44] font-semibold'>Valuable</h3>
