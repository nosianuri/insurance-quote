...
const FeAbout = () => {
  return (
    ...
    <div className='mx-28'>
    <h1 className='font-bold text-3xl text-center'>Protection for when your family needs it most.</h1>
      ...
      <h3 className='text-center font-bold text-3xl mb-5'>Understanding Final Expense Insurance</h3>
      ...
      <div className='flex mt-10'>
          <div className='bg-base-100 shadow-2xl p-10 lg:mr-[-335px] relative mt-8'>
            <h1 className='font-bold text-3xl'>Get a final expense insurance quote</h1>
            <p className='my-3'>Get a final expense insurance quote and compare rates in as little as 60 seconds.</p>
