...
const FeAbout = () => {
  return (
    ...
    <FeInfo />
      ...
      <div>
        <h3 className='text-3xl mb-3'>How can Final Expense Insurance help you?</h3>
        <div className='grid lg:grid-cols-3 grid-cols-1 gap-5'>
          <div>
          <img src={feimg1} alt="" />
          <h5 className='font-semibold mb-2'>Out-of-Pocket Medical Bills:</h5>
          ...
          <div>
            <img src={feimg2} alt="" />
            <h5 className='font-semibold mb-2'>Legal and Accounting Costs:</h5>
          ...
          <div>
            <img src={feimg3} alt="" />
            <h5 className='font-semibold mb-2'>Funeral and Burial Expenses:</h5>
      ...
      <h5 className='font-semibold text-2xl text-center my-5'>Final Expense Whole Life Insurance</h5>
