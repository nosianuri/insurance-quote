...
const MediCarePolicy = () => {
    return (
        <div className='my-5'>
            <h2 className='text-2xl font-semibold text-center'>Shop Our Medicare Insurance Policies With Our Specialized Insurance Brokers</h2>
            ...
            <h4 className='text-xl text-center font-semibold'>Choose Insurance Trendy Quote Broker for Your Medicare Insurance</h4>
            ...
            <div className='grid lg:grid-cols-3 grid-cols-1 gap-5'>
                ...
                <div className='text-center'>
                    ...
                    <p className='text-sm mt-2'>At AMC, we understand how much your assets mean to you and how hard you’ve worked to build a Medicare for your family. Our policies protect you financially and give you the peace of mind you deserve.</p>
                </div>
            </div>
        </div>
    )
