...
const McAbout = () => {
  return (
    <div className='lg:mx-36 my-10'>
      ...
      <h1 className='head-title lg:text-5xl text-2xl font-semibold text-center lg:mb-10 mb-5'>Healthier happens together</h1>
      ...
      <div className='lg:flex mt-10'>
          <div className='bg-base-100 shadow-2xl p-10 lg:mr-[-335px] relative mt-8'>
            <h1 className='head-title font-bold lg:text-3xl text-xl'>Find medicare insurance plans for the whole family</h1>
