...
const MotorAbout = () => {
  return (
    <div className='mx-36 my-10'>
      <div className='mx-28'>
        <h1 className='text-center font-semibold text-5xl mb-10'>Gear up for the road knowing you’re protected</h1>
        ...
        <h3 className='text-3xl text-center mb-5'>Start a motorcycle insurance quote online</h3>
        ...
        <div className='flex my-10'>
          <div className='border-4 border-white border-r-gray-300'>
            <h2 className='text-5xl'>What does motorcycle insurance cover?</h2>
          </div>
        ...
        <div className='flex'>
          <div className='bg-base-100 shadow-2xl p-10 lg:mr-[-335px] relative mt-8'>
            <h1 className='font-bold text-3xl'>Get Progressive motorcycle insurance today</h1>
            <p className='my-3'>Get covered and get riding. Get a quick, personalized motorcycle insurance quote today, and then hit the open road.</p>
