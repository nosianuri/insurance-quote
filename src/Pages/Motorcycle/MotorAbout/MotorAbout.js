  ...
  return (
    <div className='lg:mx-36 my-10'>
      <div className='lg:mx-28 mx-5'>
        ...
        <h3 className='text-[#201e44] lg:text-3xl text-xl  mb-3'>Start a motorcycle insurance quote online</h3>
        ...
        <MotorInfo />
        <h5 className='text-[#201e44] text-2xl font-semibold mt-5 text-center'>If it's cool enough to ride, it's cool enough to cover</h5>
        ...
        <div className='flex my-10'>
          <div className='border-4 border-white border-r-gray-300'>
            <h2 className='text-[#201e44] lg:text-5xl mr-5 italic'>What does motorcycle insurance cover?</h2>
          </div>
