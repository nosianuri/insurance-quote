...
const MotorPolicy = () => {
    return (
        <div className='my-5'>
            <h2 className='text-2xl font-semibold text-center'>Take Advantage Of The Benefits Of Motorcycle Policies With Insurance Trendy Quote</h2>
            ...
            <h4 className='text-xl text-center font-semibold'>Choose Insurance Trendy Quote Broker for Your Motorcycle Insurance</h4>
