  ...
  return (
    <div className='max-w-7xl mx-auto my-10'>
      <div className='lg:mx-28 mx-5'>
        <h2 className='text-[#201e44] head-title  font-semibold lg:text-5xl text-2xl text-center mb-8'>Life insurance helps protect the ones you love</h2>
        ...
        <div className='lg:flex my-10'>
          <div className='border-4 border-white border-r-gray-300'>
            <h2 className='text-[#201e44] lg:text-4xl text-2xl mr-5 font-semibold'>What factors shape my life insurance cost?</h2>
          </div>
          ...
          <div className='mx-5'>
            ...
            <ul className='terms-article'>
              <li><span className='text-[#201e44] font-bold'>Age:</span> Generally, the younger you are when you buy your policy, the lower your premium will be.</li>
              <li><span className='text-[#201e44] font-bold'>Term vs. Permanent:</span> Term policies are significantly less expensive than permanent plans.</li>
              <li><span className='text-[#201e44] font-bold'>Length of term:</span> Term policies are available in 10- to 40-year term lengths.</li>
              <li><span className='text-[#201e44] font-bold'>Coverage amount:</span> A policy with a larger death benefit amount will naturally cost more than a similar policy with a smaller benefit amount.</li>
              <li><span className='text-[#201e44] font-bold'>Health history:</span> Things like your current health, health history and family medical history all shape your price.</li>
        ...
        <div className='lg:flex mt-10'>
          <div className='bg-base-100 shadow-2xl p-10 lg:mr-[-335px] relative mt-8'>
            <h1 className='text-[#201e44] head-title font-bold lg:text-3xl text-xl'>Get better life insurance today</h1>
