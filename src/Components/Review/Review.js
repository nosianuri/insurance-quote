    ...
    <div className='my-10 mx-5'>
        <div className='lg:flex max-w-5xl mx-auto space-y-5 gap-8 group'>
            ...
            <i class="fa-solid fa-file-invoice text-white text-7xl "></i>
                ...
                <h4 className='text-center head-title uppercase text-xl font-bold text-white'>Top Carriers</h4>
            ...
            <i class="fa-solid fa-arrow-up-right-dots text-white text-7xl "></i>
                ...
                <h4 className='text-center head-title uppercase text-xl font-bold text-white'>Compare Quotes</h4>
            ...
            <i class="fa-solid fa-sack-dollar text-white text-7xl "></i>
                ...
                <h4 className='text-center head-title uppercase text-xl font-bold text-white'>Save Time & Money</h4>
