        ...
        <ul className="flex items-center justify-center font-semibold">
          <li className="relative group px-3 py-2">
            ...
            <div
              ...
              <div className="relative top-6 p-6 bg-[#201e44] rounded-xl shadow-xl w-full">
                <div
                  className="w-10 h-10 bg-[#201e44] transform rotate-45 absolute top-0 z-0 translate-x-0 transition-transform group-hover:translate-x-[12rem] duration-500 ease-in-out rounded-sm">
                </div>
