            ...
            <div className='grid lg:grid-cols-2 grid-cols-1 max-w-7xl mx-auto justify-center items-center border-2 border-l-[#e3e3e3] shadow-xl'>
                ...
                <div className='lg:flex md:flex '>
                    <div className='p-5 border border-white border-l-[#e3e3e3] align-middle'>
                        <div className='mt-5'>
                            <div className='text-center mb-5'>
                                <i className="fa-solid fa-file-invoice text-[#201e44] text-5xl "></i>
                            </div>
                    ...
                    <div className='p-5 border border-white border-l-[#e3e3e3]'>
                        <div className='mt-5'>
                            <div className='text-center mb-5'>
                                <i className="fa-solid fa-arrow-up-right-dots text-[#201e44] text-5xl "></i>
                            </div>
                    ...
                    <div className='p-5  border border-white border-l-[#e3e3e3]'>
                        <div className='mt-5'>
                            <div className='text-center mb-5'>
                                <i className="fa-solid fa-sack-dollar text-[#201e44] text-5xl "></i>
                            </div>
